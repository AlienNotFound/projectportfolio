...
{
    public partial class programmering : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataTable tabCat = objArt.GetCat("programmering", pg);
                ...
                DataTable allR = objArt.GetCatPg("programmering");
                ...
                {
                    pageNm++;
                    sidenav.Text += "<a href='programming.aspx?page=" + pageNm + "' />" + pageNm + "</a> ";
                }
            }
        ...
        protected void btnSrc_Click(object sender, EventArgs e)
        {
            ...
            if (chkFilter.SelectedIndex == 0)
            {
                ...
                DataTable dt = objArt.srctest(tbl1, tbl2, cell1, cell2, cell3, srcTxt, "programmering");
